# -*- coding: utf-8 -*-
"""
Counts-only V3 truth diagnostic: history + local brightness + exact-FDR event discrimination.
...
This is a diagnostic, not a proof of microscopic mechanism.  A transition
that survives these controls is a much stronger candidate for a real charge
change; a transition that disappears is measurement-sensitive.
"""
