# """
# press play to see sequence. double trouble pulse sequence, variable time in between pulses
...
def get_seq(pulse_streamer, config, args):
    ...
    meas_buffer = np.int64(1000)
    laser_buffer = np.int64(
        54
    )  # one day be less lazy and actually change the laser delay
    front_buffer = np.int64(laser_delay)
