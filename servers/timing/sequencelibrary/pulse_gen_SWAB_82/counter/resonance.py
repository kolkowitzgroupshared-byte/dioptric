...
#     pol_ns, readout_ns, uwave_ind, readout_vkey_arg, laser_power = args
...
#     period = np.int64(front_buffer+uwave_ns+transient+ 2 * (pol_ns +  transient + readout_ns+meas_buffer))
...
#     args = [5e3, 300, 0, "SPIN_READOUT", None]
