...
if __name__ == "__main__":
    ...
    data = dm.get_raw_data(
        file_stem="2026_03_24-15_18_11-qnami-nv0_2026_02_20", load_npz=True
    )
    ...
    initial_peaks = np.array([[337.781, 361.244], [311.623, 10.851], [18.034, 209.457]])
    # red calibration
    # initial_peaks = np.array([[123.486, 9.115], [16.951, 242.751], [237.556, 240.186]])
    # gree calibration
    # initial_peaks = np.array([[214.998, 203.945], [367.181, 25.354], [229.35, 379.51], [34.93, 44.916]])
